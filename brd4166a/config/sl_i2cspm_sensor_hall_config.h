...
// I2C1 SCL on PC5
#define SL_I2CSPM_SENSOR_HALL_SCL_PORT           gpioPortC
#define SL_I2CSPM_SENSOR_HALL_SCL_PIN            5
#define SL_I2CSPM_SENSOR_HALL_SCL_LOC            17

// I2C1 SDA on PC4
#define SL_I2CSPM_SENSOR_HALL_SDA_PORT           gpioPortC
#define SL_I2CSPM_SENSOR_HALL_SDA_PIN            4
#define SL_I2CSPM_SENSOR_HALL_SDA_LOC            17
// [I2C_SL_I2CSPM_SENSOR_HALL]$
// <<< sl:end pin_tool >>>
