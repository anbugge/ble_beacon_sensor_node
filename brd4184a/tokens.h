...
#define SENSING_TIME_BASE_OFFSET    0x0310
#define SENSING_TIME_BASE_ADDR      (TOKEN_USERDATA_BASE_ADDRESS + SENSING_TIME_BASE_OFFSET)
#define SENSING_TIME_BASE_SIZE      4
